...
public class MoreOptionDialog extends Dialog implements
	...
	public MoreOptionDialog(Context context,TextView tvTishi,int NoticePicPlayTime,int style,Handler handler,boolean isFullScreen) {
		super(context,style);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_option_dialog);	
