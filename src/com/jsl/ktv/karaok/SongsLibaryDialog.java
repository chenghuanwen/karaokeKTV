...
public class SongsLibaryDialog extends Dialog implements android.view.View.OnClickListener{
	...
	private View view;
	public SongsLibaryDialog(Context context) {
		super(context);
	...
	public SongsLibaryDialog(Context context,int them){
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		view = getLayoutInflater().inflate(R.layout.song_libary_manager_fragment, null);
		setContentView(view);
