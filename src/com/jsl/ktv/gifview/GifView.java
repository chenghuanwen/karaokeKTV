...
public class GifView extends View implements GifAction{
    ...
    public void parseOk(boolean parseStatus,int frameIndex){
    	if(parseStatus){
    		if(gifDecoder != null){
					//Log.i("gif", "====JSL==== animationType = " +animationType);
    ...
    private class DrawThread extends Thread{	
    	public void run(){
    		if(gifDecoder == null){
				//Log.i("gif", "====JSL==== gifDecoder = null" );
    			return;
    		}
    		while(isRun){
    			if(pause == false){
	    			//if(gifDecoder.parseOk()){
						//Log.i("gif", "====JSL==== DrawThread =run" );
						try{
						...
						Log.i("gif", "====JSL==== currentImage = null" );
						}
	    			//}else{
					//	Log.i("gif", "====JSL==== currentImage = null" );
	    			//	currentImage = gifDecoder.getImage();
					...
					Log.i("gif", "====JSL==== SystemClock sleep" );
